...
import static top.deeke.jni.v8.V8Value.BOOLEAN;
import static top.deeke.jni.v8.V8Value.DOUBLE;
import static top.deeke.jni.v8.V8Value.INTEGER;
import static top.deeke.jni.v8.V8Value.NULL;
import static top.deeke.jni.v8.V8Value.STRING;
import static top.deeke.jni.v8.V8Value.UNDEFINED;
import static top.deeke.jni.v8.V8Value.V8_ARRAY;
import static top.deeke.jni.v8.V8Value.V8_FUNCTION;
import static top.deeke.jni.v8.V8Value.V8_OBJECT;
...
public class V8ArrayTest {
    ...
    public void testUndefinedNotReleased() {
        top.deeke.jni.v8.V8Array.Undefined undefined = new V8Array.Undefined();
        undefined.close();
