...
public class V8Test {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    result[0] = Objects.requireNonNull(e.getMessage()).contains("Invalid V8 thread access");
                }
            }
        });
        t.start();
    ...
    public void testReleaseAttachedObjects() {
        ...
        runtime.registerResource((Releasable) v8Object);
    ...
    public void testReleaseSeveralAttachedObjects() {
        V8 runtime = V8.createV8Runtime();
        runtime.registerResource((Releasable) new V8Object(runtime));
        runtime.registerResource((Releasable) new V8Object(runtime));
        runtime.registerResource((Releasable) new V8Object(runtime));
