...
import top.deeke.jni.v8.inspector.V8InspectorDelegate;
import top.deeke.jni.v8.utils.V8Executor;
import top.deeke.jni.v8.utils.V8Map;
import top.deeke.jni.v8.utils.V8Runnable;
...
public class V8 extends V8Object {
    ...
    private final Map<Long, MethodDescriptor> functionRegistry = new HashMap<>();
    private final LinkedList<ReferenceHandler> referenceHandlers = new LinkedList<>();
    private final LinkedList<V8Runnable> releaseHandlers = new LinkedList<>();

    private static boolean nativeLibraryLoaded = false;
    private static Error nativeLoadError = null;
    private static Exception nativeLoadException = null;
    private static final V8Value undefined = new V8Object.Undefined();
    ...
    private Object[] getArgs(final V8Object receiver, final MethodDescriptor methodDescriptor, final V8Array parameters, final boolean hasVarArgs) {
        ...
        populateParameters(parameters, varArgIndex, args, varArgs, methodDescriptor.includeReceiver);
        if (hasVarArgs) {
    ...
    private void populateParameters(final V8Array parameters, final int varArgIndex, final Object[] args, final List<Object> varArgs, final boolean includeReceiver) {
        int start = 0;
        if (includeReceiver) {
            start = 1;
        }
