...
import top.deeke.jni.v8.ReferenceHandler;
import top.deeke.jni.v8.V8;
import top.deeke.jni.v8.V8Value;

public class MemoryManager {

    private final MemoryManagerReferenceHandler memoryManagerReferenceHandler;
    private final V8 v8;
    private final ArrayList<V8Value> references = new ArrayList<V8Value>();
