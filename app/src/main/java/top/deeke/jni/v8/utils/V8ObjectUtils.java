...
import top.deeke.jni.v8.V8Array;
...
public class V8ObjectUtils {
    ...
    public static Object getValue(final Object v8Object, final TypeAdapter adapter) {
        try (V8Map<Object> cache = new V8Map<>()) {
    ...
    public static Map<String, ? super Object> toMap(final V8Object object, final TypeAdapter adapter) {
        try (V8Map<Object> cache = new V8Map<Object>()) {
    ...
    private static V8Object toV8Object(final V8 v8, final Map<String, ?> map, final Map<Object, V8Value> cache) {
    ...
    private static V8Array toV8Array(final V8 v8, final List<?> list, final Map<Object, V8Value> cache) {
